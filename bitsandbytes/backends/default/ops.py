...
@register_kernel("bitsandbytes::int8_mm_dequant", "")
def _(
    A: torch.Tensor,
...
@register_kernel("bitsandbytes::int8_mixed_scaled_mm", "")
def _(
    A: torch.Tensor,
    CA: torch.Tensor,
    CB: torch.Tensor,
...
@register_kernel("bitsandbytes::int8_scaled_mm", "")
def _(
    A: torch.Tensor,
    B: torch.Tensor,
    row_stats: torch.Tensor,
...
@register_kernel("bitsandbytes::int8_linear_matmul", "")
def _(A: torch.Tensor, B: torch.Tensor):
    return _int8_linear_matmul_impl(A, B)


@register_kernel("bitsandbytes::int8_linear_matmul.out", "")
...
@register_kernel("bitsandbytes::int8_vectorwise_quant", "")
...
@register_kernel("bitsandbytes::dequantize_blockwise", "")
